...
<html>
  ...
  if (authLoading || loading) {
    return (
      <div className="min-h-screen bg-v2-surface-950 text-v2-ink-50 font-v2-body">
        <div className="container py-10">
          <div className="rounded-v2-md border border-v2-surface-800 bg-v2-surface-900 px-6 py-8 text-center text-v2-sm text-v2-ink-300 shadow-v2-elev-1 font-v2-mono tabular-nums uppercase tracking-[0.18em]">
            Loading Attendance…
          </div>
        </div>
      </div>
  ...
  if (!isCoach) {
    return (
      <div className="min-h-screen bg-v2-surface-950 text-v2-ink-50 font-v2-body">
        <div className="container py-10">
          <div className="rounded-v2-md border border-v2-surface-800 bg-v2-surface-900 px-6 py-6 space-y-3 shadow-v2-elev-1">
            <div className="flex items-center gap-3">
              <div className="h-px w-5 bg-v2-info-600" />
              <span className="text-v2-xs uppercase tracking-[0.22em] text-v2-info-300 font-semibold">
                Coach Only
              </span>
            </div>
            <h2 className="text-xl font-v2-heading uppercase tracking-tight text-v2-ink-50">
  ...
  return (
    <div
      className={[
        "min-h-screen bg-v2-surface-950 text-v2-ink-50 font-v2-body container py-6 space-y-6",
    ...
    >
      <ConfirmModal
        ...
        variant="danger"
      />
      <div className="rounded-v2-md border border-v2-surface-800 bg-v2-surface-900 shadow-v2-elev-1 space-y-2 p-3 sm:space-y-3 sm:p-6">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 justify-between">
          <div>
            ...
            <h1 className="text-xl font-v2-heading uppercase tracking-tight text-v2-ink-50 sm:text-2xl">Attendance</h1>
            <p className="hidden text-v2-sm text-v2-ink-300 sm:block">
